...
case class DependencyAnalysisReporter(name: String = "dependencyAnalysis_reporter", path: String = "report.csv") extends Reporter {
  var assumptionAnalysisInterpretersPerMember: List[AssumptionAnalysisInterpreter] = List.empty
  var joinedAssumptionAnalysisInterpreter: Option[AssumptionAnalysisInterpreter] = None
