...
class DependencyAwareMainVerifier(config: Config,
  ...
  override def allProvers: AllProvers with DependencyAnalysisProverFeatures = DependencyAwareAllProvers

  object DependencyAwareAllProvers extends AllProvers with DependencyAnalysisProverFeatures {
