...
set __CP.SCALLOP_LIB="%IVY_HOME%\cache\org.rogach\scallop_%SCALA_SVER%\jars\scallop_%SCALA_SVER%-0.9.4.jar"
...
set __CP.KIAMA_LIB="%IVY_HOME%\cache\com.googlecode.kiama\kiama_%SCALA_SVER%\jars\kiama_%SCALA_SVER%-1.5.0.jar"
