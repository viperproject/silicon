...
REM Silicon
set __CP.SILICON_COMMON=%BASE_DIR%\common\target\scala-%SCALA_SVER%\silicon-magic-wands-common_%SCALA_SVER%-%SILICON_VERSION%.jar
set __CP.SILICON_JAR=%BASE_DIR%\target\scala-%SCALA_SVER%\silicon-wands_%SCALA_SVER%-%SILICON_VERSION%.jar
)
